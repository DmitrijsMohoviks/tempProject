...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/tempProjectDataSource" pool-name="tempProjectDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/tempProjectDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="tempProjectSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/tempProjectDataSource"/>
...
7. add database H2
URL:
jdbc:h2:~/tempProjectDatabase;AUTO_SERVER=TRUE
user:
sa
password:
sa
